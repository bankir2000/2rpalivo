  ...
  , jc = {
    ...
    data() {
        return {
            ...
            tcil: null,
       //     noTarget: ["б/н, ціль на Віражі відсутня"],
            ammunition_consumption: null,
            ak_ammunition_consumption: null,
            dshk_ammunition_consumption: null,
            browning_ammunition_consumption: null,
    ...
    computed: {
      ...
      (this.form.nearestCity ? ` \u0432 \u0440\u0430\u0439\u043E\u043D\u0456 \u043D.\u043F. ${this.form.nearestCity}` : "") + 
      ...
      (this.form.tcil ? " \u0426\u0456\u043B\u044C № " + this.form.tcil + " " : 
       (this.form.noTarget ? " \u0426\u0456\u043B\u044C № б/н, ціль на Віражі відсутня " : "")) + 
...
B("div", { class: "mt-2" }, [
    F(f, {
        id: "no_target_checkbox",
        checked: r.form.noTarget,
        "onUpdate:checked": t[35] || (t[35] = d => {
            r.form.noTarget = d;
            // Встановлюємо значення tcil залежно від стану чекбоксу
            if (d) {
                r.form.tcil = "б/н, ціль на Віражі відсутня"; // Якщо вибрано
            } else {
                r.form.tcil = ""; // Якщо не вибрано
            }
        }),
        type: "checkbox",
        class: "mr-2"
    }, null, 8, ["checked"]),
    B("label", { for: "no_target_checkbox", class: "text-white" }, "б/н, ціль на Віражі відсутня")
]),
    B("div", qc, [F(l, {
